<div class="content-wrapper">
    ...
    <section class="content" style="min-height: 800px;">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-2 form-inline">
                    <div class="form-group area-search-control-view">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url(); ?>addarea_foreign">
                            <span>新增</span>
                        </a>
                    ...
                    for ($i = 0; $i < $areaCount; $i++) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($area->status == 0) {
                                    ?>
                                    <a href="<?php echo base_url(); ?>editarea_foreign/<?php echo $area->id; ?>">编辑&nbsp;</a>
        ...
        </div><input id="countryList" value='<?php echo json_encode($countryList); ?>' style="display: none">
    </section>
</div>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/area_foreign.js" charset="utf-8"></script>