...
<head>
    ...
    if ($map_type == 0) {
        ?>
        <script src="http://webapi.amap.com/maps?v=1.3&key=0250860ccb5953fa5d655e8acf40ebb7&plugin=AMap.ToolBar,AMap.Walking,AMap.Driving"></script>
	...
	<script type="text/javascript" src="http://maps.google.cn/maps/api/js?key=AIzaSyBmofwXO4eBxqJY_GxcWJqoVtUnb4GtQAs&amp;sensor=false&amp;language=zh-CN&amp;libraries=places"></script>
        ...
        <!--////////////////////////// -->
        <script type="text/javascript" src="js/map_google.js"></script>
        <?php
    }
    ?>
...
<div id="content">
    ...
    <div class="btn-right" id="btn-login" onclick="$('#login').show();showDialogToCenter('login-dialog');"></div>
        ...
        <div class="modal-dialog" id="login-dialog">
            <div class="modal-content" style="background: rgba(0,0,0,0);box-shadow: none">
                <div class="modal-header" style="padding: 0px">
                    ...
                    <img src="resource/image/close.png" id="btn-close" onclick="Login_dialog_close()"
                ...
                <div class="modal-footer">
                    <div class="text-button" style="border-bottom-left-radius: 7px" onclick="verifyAuthorizationCode()">
                        授权认证
                    </div>
                    <div class="text-button" id="btn_online_pay" style="border-bottom-right-radius: 7px"
                         onclick="processInfoEvents(4,0)">立即购买
                    </div>
                </div>
            </div>
            <!-- /.modal-content -->
        ...
        <div class="modal-dialog" id="menu-detail-dialog">
            <div class="modal-content" style="height: 100%">
                ...
                <div class="modal-body" id="menu-detail-content" style="height: 90%; padding-top: 5px">
                    ...
                    <div id="detail_content_data" style="overflow-y: scroll; height: 87%"></div>
                </div>
        ...
        <div class="modal-dialog" id="help-dialog">
            <div class="modal-content" style="height: 100%">
                ...
                <div class="modal-body" id="help-content" style="overflow-y: scroll; padding: 0px 10px">
                    ...
                    <h5 style="line-height: 1.5">2.
                        如该景区是还没有授权过的,点击“讲解”时，就会出现“授激活”的弹框，若您有购买过授权码的“输入授权码”即可;如果没有购买过该景区的授权码，您可以点击“立即购买”按钮讲行购买。</h5>
                </div>
                <div class="modal-footer" style="padding: 0px; border: none">
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function play_area_explain() {
        ...
        //alert('started11');
        //document.getElementById('area_music').autoplay=false;
        //else document.getElementById('area_music').autoplay=true;
...
//    	auio[0].play();
	...
	//document.getElementById('area_music').setAttribute('autoplay',true);
	//play_area_explain();
	//return;
        if(is_weixin()){
        ...
        */
        ...
        switch (index) {
            ...
            case 4:  // click 更多景区 menu item
                ...
                window.location.href = "tourism_manage.php?type=0";
                break
        }
    }
