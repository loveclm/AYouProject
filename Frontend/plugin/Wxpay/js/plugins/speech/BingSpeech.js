...
(function (BingSpeech) {
    ...
    (function (SupportedLocales) {
        ...
        SupportedLocales[SupportedLocales["koKR_Female"] = 29] = "koKR_Female";
        SupportedLocales[SupportedLocales["caES_Female"] = 30] = "caES_Female";
        SupportedLocales[SupportedLocales["daDK_Female"] = 31] = "daDK_Female";
        SupportedLocales[SupportedLocales["fiFI_Female"] = 32] = "fiFI_Female";
        SupportedLocales[SupportedLocales["hiIN_Male"] = 33] = "hiIN_Male";
        SupportedLocales[SupportedLocales["nbNO_Female"] = 34] = "nbNO_Female";
        SupportedLocales[SupportedLocales["nlNL_Female"] = 35] = "nlNL_Female";
        SupportedLocales[SupportedLocales["plPL_Female"] = 36] = "plPL_Female";
        SupportedLocales[SupportedLocales["svSE_Female"] = 37] = "svSE_Female";
        ...
        makeSSML(text, localeAsked) {
            ...
            switch (localeAsked) {
                case SupportedLocales.arEG_Female:
                    ...
                    break;
                case SupportedLocales.caES_Female:
                    locale = "'ca-es'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (ca-ES, HerenaRUS)";
                    break;
                case SupportedLocales.daDK_Female:
                    locale = "'da-dk'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (da-DK, HelleRUS)";
                    break;
                ...
                case SupportedLocales.esMX_Male:
                    ...
                    break;
                case SupportedLocales.fiFI_Female:
                    locale = "'fi-fi'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (fi-FI, HeidiRUS)";
                    break;
                ...
                case SupportedLocales.frFR_Male:
                    ...
                    break;
                case SupportedLocales.hiIN_Male:
                    locale = "'hi-in'";
                    gender = "'Male'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (hi-IN, Hemant)";
                    break;
                ...
                case SupportedLocales.jaJP_Male:
                    ...
                    break;
                case SupportedLocales.koKR_Female:
                    locale = "'ko-kr'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (ko-KR, HeamiRUS)";
                    break;
                case SupportedLocales.nbNO_Female:
                    locale = "'nb-no'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (nb-NO, HuldaRUS)";
                    break;
                case SupportedLocales.nlNL_Female:
                    locale = "'nl-nl'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (nl-NL, HannaRUS)";
                    break;
                case SupportedLocales.plPL_Female:
                    locale = "'pl-pl'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (pl-PL, PaulinaRUS)";
                    break;
                ...
                case SupportedLocales.ruRU_Male:
                    ...
                    break;
                case SupportedLocales.svSE_Female:
                    locale = "'sv-se'";
                    gender = "'Female'";
                    supportedLocaleValue = "Microsoft Server Speech Text to Speech Voice (sv-SE, HedvigRUS)";
                    break;
